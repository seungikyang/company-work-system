...
1. 오늘 구현할 FR ID와 연결되는 문제를 고릅니다.
2. `hard/` 또는 `starter/`에서 먼저 직접 작성합니다.
3. 막힌 지점과 실제 오류를 기록한 뒤에만 `answers.md`를 확인합니다.
4. 같은 기능을 실행 가능한 Spring Boot 프로젝트에 구현합니다.
5. 테스트 결과와 코드·커밋 링크를 [취업 준비 통합 워크북](./job-preparation-workbook.md)에 남깁니다.

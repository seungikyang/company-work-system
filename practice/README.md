...
권장 학습 루프: **hard 에서 백지에 가깝게 작성 → 같은 번호 starter 로 구조 확인 → answers 로 "왜" 확인**. 자세한 규칙은 `hard/README.md` 참고. 워크시트형 Markdown 챕터(20, 22, 35–39)는 원래 서술 작성량이 많아 `starter/` 하나로 충분합니다.
